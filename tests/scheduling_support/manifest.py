...
TEST_NODES = {
    ...
    "AC-027-N-1": "tests/unit/test_loop_state.py::TestCircuitBreakerScenarios::test_ac027_n1_failed_run_increments_streak",
    "AC-027-N-2": "tests/unit/test_loop_state.py::TestCircuitBreakerScenarios::test_ac027_n2_done_run_resets_streak",
    "AC-027-N-3": "tests/unit/test_loop_state.py::TestCircuitBreakerScenarios::test_ac027_n3_five_failures_pause_loop",
    "AC-027-N-4": "tests/e2e/test_scheduling_e2e.py::TestLoopCircuitBreaker::test_ac027_n4_paused_loop_task_deferred_not_error",
    "AC-027-B-1": "tests/unit/test_loop_state.py::TestCircuitBreakerScenarios::test_ac027_b1_threshold_frontmatter_override",
    "AC-027-B-2": "tests/unit/test_loop_state.py::TestUnpauseCli::test_ac027_b2_unpause_clears_and_dispatch_resumes",
    "AC-027-B-3": "tests/e2e/test_scheduling_e2e.py::TestLoopCircuitBreaker::test_ac027_b3_manual_run_not_blocked_by_pause",
    "AC-027-E-1": "tests/e2e/test_scheduling_e2e.py::TestLoopCircuitBreaker::test_ac027_e1_corrupted_loop_state_treated_as_initial",
    "AC-027-F-1": "tests/unit/test_loop_state.py::TestCircuitBreakerScenarios::test_ac027_f1_manual_run_failure_counts",
