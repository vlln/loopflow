...
class OpencodeBackend(BaseBackend):
    ...
    def __init__(self, transport: str | None = None, text_handler=None, thought_handler=None, backend_name: str = "opencode"):
        ...
        if use_acp:
            ...
            self._acp = None
            self._cli = _OpencodeCli(text_handler=text_handler, thought_handler=thought_handler, backend_name=backend_name)
