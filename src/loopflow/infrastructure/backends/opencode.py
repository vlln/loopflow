...
class OpencodeBackend(BaseBackend):
    ...
    def __init__(self, transport: str | None = None, text_handler=None, thought_handler=None, session_handler=None, backend_name: str = "opencode"):
        ...
        if use_acp:
            ...
            self._acp = None
            self._cli = _OpencodeCli(text_handler=text_handler, thought_handler=thought_handler, session_handler=session_handler, backend_name=backend_name)
    ...
    def create_session(self, user: str, system: str | None = None, model: str | None = None, system_mode: str = "append", agent_def: AgentDef | None = None) -> tuple[str, int]:
        if self._acp:
            try:
                ...
                self._acp = None
                self._cli = _OpencodeCli(text_handler=self._th, thought_handler=self._thought_handler)
