...
class KiroBackend(BaseBackend):
    ...
    def __init__(self, transport: str | None = None, text_handler=None, thought_handler=None, session_handler=None, backend_name: str = "kiro"):
        ...
        if use_acp:
            ...
            self._acp = None
            self._cli = _KiroCli(text_handler=text_handler, thought_handler=thought_handler, session_handler=session_handler, backend_name=backend_name)
