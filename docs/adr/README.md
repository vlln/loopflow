...
| [0055](0055-single-agent-run.md) | 单 agent 运行入口 | proposed | BL-047 / Spec v17 / AC-032 |
| [0056](0056-waiting-input-lifecycle.md) | waiting_input 生命周期：CLI 应答通道与无人值守策略 | proposed | BL-044 / BL-045 / ADR-0036 §5 / Spec v17 / AC-031 |
