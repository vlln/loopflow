...
| [0042](0042-run-working-directory.md) | Run 显式工作目录 | proposed | Spec / AC-0013 / ADR-0039 |
| [0043](0043-file-observation-baseline.md) | 文件观察基线快照语义 | proposed | Spec / AC-0012 / ADR-0039 |
