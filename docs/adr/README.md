...
| [0033](0033-webui-architecture.md) | 本地 WebUI 技术栈与分层 | proposed | Spec v19 / ADR-0052 修订 |
| [0034](0034-web-event-run-lifecycle.md) | Web 事件与 Run 生命周期契约 | proposed | Spec v19 / ADR-0052 修订 |
...
| [0041](0041-sse-multi-topic-transport.md) | SSE 多 topic 传输层 | proposed | Spec v19 / ADR-0034 §5 / ADR-0052 修订 |
