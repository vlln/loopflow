...
| BL-009 | 非 macOS 目录选择器 | Web UI 目录选择器在非 macOS 平台的适配（ADR-0053：GET /system/list-directory + Web 模态浏览器替代 osascript） | 0.20.0 发布评估 | planned | 0096-web-directory-picker |
